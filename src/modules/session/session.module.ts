...
@Module({
  // WebhookModule/StatusStoreModule/ChatMediaModule/AutomationModule/StatsModule do not import SessionModule
  ...
  exports: [SessionService, MessageProjector, SessionOwnershipService, SessionSchedulerService],
})
