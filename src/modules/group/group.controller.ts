import { Controller, Get, Post, Put, Delete, Param, Body, Query, HttpCode, HttpStatus, Header } from '@nestjs/common';
...
export class GroupController {
  ...
  @Get('export/all-participants/csv')
  @Header('Content-Type', 'text/csv')
  @Header('Content-Disposition', 'attachment; filename="all_groups_participants.csv"')
  @ApiOperation({ summary: 'Export all group participants across all groups as CSV' })
  @ApiParam({ name: 'sessionId', description: 'Session ID' })
  async exportAllParticipantsCsv(@Param('sessionId') sessionId: string): Promise<string> {
    return this.groupService.exportAllGroupsParticipantsCsv(sessionId);
  }

  @Get(':groupId/participants/export/csv')
  @Header('Content-Type', 'text/csv')
  @Header('Content-Disposition', 'attachment; filename="group_participants.csv"')
  @ApiOperation({ summary: 'Export single group participants as CSV' })
  @ApiParam({ name: 'sessionId', description: 'Session ID' })
  ...
  async exportParticipantsCsv(
    ...
    return this.groupService.exportGroupParticipantsCsv(sessionId, groupId);
  }
