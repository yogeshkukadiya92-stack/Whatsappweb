...
@Module({
  imports: [
    TypeOrmModule.forFeature([Message, MessageBatch, ScheduledMessage, Session], 'data'),
    SessionModule,
    TemplateModule,
    ChatMediaModule,
  ],
  ...
  exports: [MessageService, BulkMessageService, SendPacingService, ScheduledMessageService],
})
